...
//    public int statusBarColor = Color.TRANSPARENT; //状态栏颜色
    public int statusBarColor = R.color.transparent; // card_divider  status_bar_color
    @ColorInt
    public int navigationBarColor = Color.BLACK;; // Color.BLACK;  //导航栏颜色
...
//    public int statusBarColorTransform = Color.BLACK;  //状态栏变换后的颜色
    public int statusBarColorTransform = R.color.status_bar_color; //状态栏变换后的颜色  status_bar_color   card_divider

//    public int statusBarColorTransform = Color.TRANSPARENT;  //状态栏变换后的颜色
    @ColorInt
    public int navigationBarColorTransform = Color.BLACK; // Color.BLACK;  //导航栏变换后的颜色
